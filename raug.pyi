...
class GraphBuilder:
    ...
    def add_audio_input(self) -> Node: ...
    def add_audio_output(self) -> Node: ...
    def add_midi_input(self, name: str) -> Node: ...
    ...
    def change_detector(self) -> Node: ...

    def check_finite(self, context: str = ...) -> Node: ...
...
class Input:
    ...
    def param(self, name: str, initial_value) -> Param: ...
    def node(self) -> Node: ...
...
class Runtime:
    ...
    def run_offline_to_file(self, filename: str, duration: float) -> None: ...
