...
class GraphBuilder:
    ...
    def sine_osc(self, frequency: float = 440.0) -> Node: ...
    def saw_osc(self, frequency: float = 440.0) -> Node: ...
    def bl_saw_osc(self, frequency: float = 440.0) -> Node: ...
    def bl_square_osc(self, frequency: float = 440.0,
                      pulse_width: float = 0.5) -> Node: ...
    ...
    def peak_limiter(self, **kwargs) -> Node: ...
